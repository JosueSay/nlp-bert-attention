...
% pandoc --from=markdown+implicit_figures+link_attributes 01-reflexion.md -o 01-reflexion.pdf --pdf-engine=xelatex -V geometry:top=0.67in -V geometry:bottom=0.67in -V geometry:left=0.85in -V geometry:right=0.85in -H header.tex --resource-path=.:images:./images
